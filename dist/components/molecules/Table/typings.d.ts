...
export interface TableColumnProps extends TableColumnType<any> {
    render?: (value: string | number | boolean, record: TableRecord) => JSX.Element | string | number | boolean;
}
...
export interface TableRecord extends ImportantIconProps, Partial<Record<string, string | number | boolean | FilterValue | null>> {
    _id?: string;
    subject?: string;
    text?: string;
    read?: boolean;
